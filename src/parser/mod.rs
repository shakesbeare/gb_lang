...
impl<'a, R: Read> Parser<'a, R> {
    pub fn new(mut lexer: Lexer<R>, error_handler: Box<dyn ErrorHandler>, verbose: bool) -> Self {
        ...
        p.precedences
            .insert(TokenKind::GreaterEquals, Precedence::LessGreater);
        p.precedences
            .insert(TokenKind::LessEquals, Precedence::LessGreater);
        ...
        p.register_infix(TokenKind::LessEquals, Parser::parse_infix_expression);
        p.register_infix(TokenKind::GreaterEquals, Parser::parse_infix_expression);
